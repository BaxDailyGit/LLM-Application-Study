...
> [!NOTE]
> Token Size하니깐 생각나는게 gemini에게 책을 추천받을때 대답하는 책 1개당 토큰 10개씩 잡아먹는것을 알수 있었던 경험이 있다.
그래서 "책 10개를 추천해줘"라고 한다면 max_token을 100이상으로 설정해줘야한다.   
max_token을 여유롭게 적용하고 예외처리를 해두었던것 같다.  
